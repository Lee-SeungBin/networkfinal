...
public class PhotonInit : MonoBehaviourPunCallbacks
{
    ...
    private void Update()
    {
        ...
        if (isGameStart == false && SceneManager.GetActiveScene().name == "Level1 1" && isLoggIn == true)
        {
    ...
    IEnumerator CreatePlayer()
    {
        ...
        GameObject tempPlayer = PhotonNetwork.Instantiate("Cyber_Soldier_1",
                                    new Vector3(23f, 1.5f, 64f),
                                    Quaternion.identity,
                                    0);
